...
class User extends React.Component<RouteComponentProps,IState>
{
        ...
        <div className="table-wrapper">
            <div className="table-title">
                <div className="row">
					...
					<div className="col-sm-6">
						<a href="#addEmployeeModal" className="btn btn-success" data-toggle="modal"><i className="material-icons">&#xE147;</i> <span>Add New Users</span></a>
